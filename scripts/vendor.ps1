...
function Copy-IconvFiles {
    ...
    # Copy sources + readme (win-iconv is public domain; the license
    # statement lives in readme.txt and the header of win_iconv.c)
    foreach ($f in @("win_iconv.c", "iconv.h", "readme.txt")) {
