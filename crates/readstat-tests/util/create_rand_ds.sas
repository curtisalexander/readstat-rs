...
%macro write_artifact_info;
  ...
  %else %do;
    data _null_;
      ...
      put "Download the dataset and manifest, then run the repository's";
      put "scripts/publish-benchmark.sh on a Linux or macOS computer.";
      put "The publication script computes and verifies size and SHA-256 locally.";
    run;
  %end;
%mend;
