...
fn parse_malformed_utf8_data() {
    ...
    assert_eq!(col.value(0), "caf\u{FFFD}", "truncated café should use replacement char");
    ...
    assert_eq!(col.value(0), "na\u{FFFD}", "truncated naïve should use replacement char");
    ...
    assert_eq!(col.value(0), "café", "full-width column preserves valid UTF-8");
