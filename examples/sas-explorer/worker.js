import {init,read_metadata,read_preview} from "./readstat_wasm.js";

// Central browser policy. The UI receives this exact configuration in `ready`.
const MiB=1024*1024;
export const POLICY=Object.freeze({recommendedBytes:250*MiB,hardMaxBytes:500*MiB,previewOptions:[25,50,100,250,500,1000],defaultPreview:100});
